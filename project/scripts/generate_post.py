...
def emit_next_steps(md_path: Path, html_path: Path, image_web_path: str) -> None:
    ...
    print()
    print("  3. Publish via branching engine:")
    print("       python /home/gruzz/bloodinthewire/project/scripts/branch_publish.py \\")
    print("         --title \"<entry title>\" \\")
    print("         --timestamp \"<HH:MM|OMIT>\" \\")
    print("         --teaser \"<one-line teaser>\" \\")
    print("         --fragment-href \"fragments/<entry-file>.html\" \\")
    print("         --posted-date \"$(date +%F)\" \\")
    print("         --image-web-path \"<web image path>\" \\")
    print("         --image-source \"library\" \\")
    print("         --links-note \"<short note>\"")
    print()
